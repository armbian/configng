...
<section class=container>
	<div class=page>
		...
		<div class=content id=about style=display:none>
			...
			<p>It is designed and tested on a <a href=https://www.khadas.com/vim3 target=_blank>Khadas VIM3</a> board running <a href=https://www.armbian.com/ target=_blank>Armbian</a>.
		</div>
	</div>
</section>
<footer>
