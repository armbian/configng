...
<section class=container>
	<div class=page>
		...
		<div class=content id=about style=display:none>
			<h1>About</h1>
             <h1>Armbian Configuration Web App</h1>
                ...
                <h2>About</h2>
                <p>The application is a static single-page app that uses JSON generated by `config-ng`. It is built on Armbian and tested on the SBC for accessibility and documentation.</p>
            
                <h2>Installation</h2>
                <p>Provide instructions on how to install and run your application.</p>
            
                <h2>Usage</h2>
                <p>Provide instructions on how to use your application.</p>
            
                <h2>Contributing</h2>
                <p>Provide instructions on how others can contribute to your project.</p>
            
                <h2>License</h2>
                <p>Include information about the license.</p>
