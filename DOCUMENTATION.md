...
~~~
  ...
  System - System wide and admin settings (x86_64)
	...
	--cmd SSH002 - Remove sandboxed SSH server (ssh://10.1.0.81:2222)
  ...
  Software - Run/Install 3rd party applications (Update the package lists.)
	...
	--cmd ADG002 - AdGuardHome remove (http://10.1.0.81:3000)
	...
	--cmd ABU002 - Actual Budget remove (http://10.1.0.81:5006)
	...
	--cmd DAT002 - Mariadb remove (Server: 10.1.0.81)
	--cmd DAT003 - Mariadb purge with data folder
	--cmd MYA001 - phpMyAdmin web interface manager
	--cmd MYA002 - phpMyAdmin remove (http://10.1.0.81:8071)
	...
	--cmd POR002 - Portainer remove (http://10.1.0.81:9000)
	...
	--cmd NAX002 - NetAlertX network scanner remove (http://10.1.0.81:20211)
	--cmd NAX003 - NetAlertX network scanner purge with data folder
    Management - Remote File & Management tools
	--cmd CPT001 - Cockpit web-based management tool (http://10.1.0.81:9090)
	...
	--cmd OCT002 - OctoPrint remove (http://10.1.0.81:7981)
