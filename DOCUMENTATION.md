...
~~~
  ...
  Software - Run/Install 3rd party applications (Update the package lists.)
	...
	--cmd ADG002 - AdGuardHome remove (http://10.1.0.52:3000)
	...
	--cmd DAT002 - Mariadb remove (Server: 10.1.0.52)
	--cmd DAT003 - Mariadb purge with data folder
	--cmd DAT005 - phpMyAdmin web interface manager
	--cmd DAT006 - phpMyAdmin remove (http://10.1.0.52:8071)
	...
	--cmd CON006 - Portainer remove (http://10.1.0.52:9000)
	...
	--cmd MAN001 - Cockpit web-based management tool (http://10.1.0.52:9090)
	...
	--cmd OCT002 - OctoPrint remove (http://10.1.0.52:7981)
