...
~~~
  ...
  Software - Run/Install 3rd party applications (Update the package lists.)
	...
	--cmd ADG002 - AdGuardHome remove (http://10.1.0.6:3000)
	...
	--cmd DAT002 - Mariadb remove (Server: 10.1.0.6)
	--cmd DAT003 - Mariadb purge with data folder
	--cmd DAT005 - phpMyAdmin web interface manager
	--cmd DAT006 - phpMyAdmin remove (http://10.1.0.6:8071)
	...
	--cmd CON006 - Portainer remove (http://10.1.0.6:9000)
	...
	--cmd OCT002 - OctoPrint remove (http://10.1.0.6:7981)
