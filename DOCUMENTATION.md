...
~~~
  ...
  System - System wide and admin settings (x86_64)
	...
	--cmd SSH002 - Remove sandboxed SSH server (ssh://10.1.0.58:2222)
  ...
  Software - Run/Install 3rd party applications (Update the package lists.)
	...
	--cmd ADG002 - AdGuardHome remove (http://10.1.0.58:3000)
	...
	--cmd DAT002 - Mariadb remove (Server: 10.1.0.58)
	--cmd DAT003 - Mariadb purge with data folder
	--cmd MYA001 - phpMyAdmin web interface manager
	--cmd MYA002 - phpMyAdmin remove (http://10.1.0.58:8071)
	...
	--cmd POR002 - Portainer remove (http://10.1.0.58:9000)
	...
	--cmd CPT001 - Cockpit web-based management tool (http://10.1.0.58:9090)
	...
	--cmd OCT002 - OctoPrint remove (http://10.1.0.58:7981)
