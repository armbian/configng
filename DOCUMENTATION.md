...
~~~
  ...
  Software - Run/Install 3rd party applications (Update the package lists.)
	...
	--cmd HAB002 - openHAB remove (http://10.1.0.150:8080)
	...
	--cmd DNS003 - Pi-hole remove (http://10.1.0.150:80)
	...
	--cmd SABN02 - SABnzbd remove (http://10.1.0.150:8080)
	...
	--cmd DAT006 - phpMyAdmin remove (http://10.1.0.150:8071)
	...
	--cmd CON006 - Portainer remove (http://10.1.0.150:9000)
