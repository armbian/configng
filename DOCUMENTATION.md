...
~~~
  ...
  Software - Run/Install 3rd party applications (Update the package lists.)
	...
	--cmd DNS003 - Pi-hole remove (http://10.1.0.186:80)
	...
	--cmd DAT006 - phpMyAdmin remove (http://10.1.0.186:8071)
	...
	--cmd CON006 - Portainer remove (http://10.1.0.186:9000)
	...
	--cmd MON002 - Uptime Kuma remove (http://10.1.0.186:3001)
	--cmd MON003 - Uptime Kuma purge with data folder
	--cmd MON005 - Netdata - monitoring real-time metrics
	--cmd MON006 - Netdata remove (http://10.1.0.186:19999)
	...
	--cmd MAN001 - Cockpit web-based management tool (http://10.1.0.186:9090)
