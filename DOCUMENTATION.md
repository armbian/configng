...
~~~
  ...
  System - System wide and admin settings (x86_64)
	...
	--cmd SSH002 - Remove sandboxed SSH server (ssh://10.1.0.180:2222)
  ...
  Software - Run/Install 3rd party applications (Update the package lists.)
	...
	--cmd DPL002 - Duplicati remove (http://10.1.0.180:8200)
	...
	--cmd PIH003 - Pi-hole remove (http://10.1.0.180:80)
	...
	--cmd DAT002 - Mariadb remove (Server: 10.1.0.180)
	--cmd DAT003 - Mariadb purge with data folder
	--cmd MYA001 - phpMyAdmin web interface manager
	--cmd MYA002 - phpMyAdmin remove (http://10.1.0.180:8071)
	...
	--cmd EMB002 - Emby server remove (http://10.1.0.180:8096)
	...
	--cmd FIL002 - Filebrowser container remove (http://10.1.0.180:8095)
	...
	--cmd IMM002 - Immich remove (http://10.1.0.180:8077)
	--cmd IMM003 - Immich purge with data folder
	--cmd JMS001 - Jellyfin Media System
	--cmd JMS002 - Jellyfin remove (http://10.1.0.180:8096)
	...
	--cmd UPK002 - Uptime Kuma remove (http://10.1.0.180:3001)
	...
	--cmd OCT002 - OctoPrint remove (http://10.1.0.180:7981)
