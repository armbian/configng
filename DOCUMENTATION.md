...
~~~
  ...
  System - System wide and admin settings (x86_64)
	...
	--cmd SY220 - ZFS filesystem - enable support (v)
  ...
  Software - Run/Install 3rd party applications (The package lists are up-to-date.)
	...
	--cmd ADG002 - AdGuardHome remove (http://172.27.153.104:3000)
	...
	--cmd DAT002 - Mariadb remove (Server: 172.27.153.104)
	--cmd DAT003 - Mariadb purge with data folder
	--cmd DAT005 - phpMyAdmin web interface manager
	--cmd DAT006 - phpMyAdmin remove (http://172.27.153.104:8071)
	...
	--cmd CON006 - Portainer remove (http://172.27.153.104:9000)
	...
	--cmd OCT002 - OctoPrint remove (http://172.27.153.104:7981)
...
| Helper module for timing code execution | help start mark stop show | @armbian 
...
| Helper module for debug info | help start mark stop show | @armbian 
